...
<!-- image removed -->/1/8052592c-97ce-4568-b82e-6153924a053c.png)

`AI 恋爱大师应用` 可以依赖 AI 大模型解决用户的情感问题，支持多轮对话、基于自定义知识库进行问答、自主调用工具和 MCP 服务完成任务，比如调用地图服务获取附近地点并制定约会计划。

<!-- image removed -->/1/1745225631067-44a111e1-1032-4f1c-bd69-9f08a59a654b.png)

此外，还会手把手带大家完成基于 ReAct 模式的 `自主规划智能体 YuManus` ，可以利用网页搜索、资源下载和 PDF 生成工具，帮用户制定完整的约会计划并生成文档：

<!-- image removed -->/1/1745224663573-04af8f65-2da4-4ef9-8033-a179e703f9c4.png)
...
<!-- image removed -->/1/1746250760306-3b545556-59df-43a9-b843-b73ec9b5a867.png)
...
<!-- image removed -->/1/ae36dd94-e87e-4dfe-ae31-81a6cc32c9e8.png)
...
<!-- image removed -->/1/1714011299057-cb31704a-6c33-410f-888d-74c2d7e1c6e4.png)

编程导航已有 **10 多套项目教程！**每个项目的学习重点不同，几乎全都是前端 + 后端的 **全栈项目** 。

可以看看大家的真实评价，很多小伙伴通过跟我做项目，提升了技术并拿到了 offer！

<!-- image removed -->/1/image-20250422160549546.png)
...
![RAG 核心特性实战](<!-- image removed -->/1/1745224085267-57afea3b-2de9-44a0-8f53-49e338c0e6b9.png)

项目架构设计图：

![AI 智能体架构图](<!-- image removed -->/1/AI%E6%99%BA%E8%83%BD%E4%BD%93%E6%9E%B6%E6%9E%84%E5%9B%BE.png)
...
<!-- image removed -->/1/image-20250120113601323-20250422160856617.png)
...
<!-- image removed -->/1/image-20250120113756426-20250422160856746.png)
...
代码仓库：https://github.com/your-username/sakura-agent
