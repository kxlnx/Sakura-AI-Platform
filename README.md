...
1. [功能模块](#1-ai-超级智能体-yumanus) — 超级智能体 / 历史知识库 / 双层记忆 / 认证会话 / 部署能力 / AI Code Review / 单元测试
2. [技术栈](#技术栈)
3. [架构](#架构)
4. [快速开始](#快速开始) — 安装 → Wiki 数据准备 → 配置密钥 → 启动
5. [配置参考](#配置参考)
6. [数据库设计](#数据库设计) — MySQL 表结构 / Milvus 向量集合
7. [项目结构](#项目结构)
8. [优化清单](#优化清单相较于原始项目的新增重构) — 架构 / 记忆系统 / 工具链 / 前端 / 认证部署
9. [致谢](#致谢)
