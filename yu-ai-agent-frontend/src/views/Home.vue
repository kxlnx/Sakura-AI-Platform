  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">Sakura Agent</h1>
      </div>
      <p class="subtitle">/ 探索AI的无限可能 /</p>
<div class="auth-bar">
  <template v-if="authed">🐤 {{ user }} <a href="#" @click.prevent="doLogout">退出</a></template>
  <a v-else href="/auth">登录 / 注册</a>
</div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/love-master')">
        ...
        <div class="app-info">
          <div class="app-title">上杉绘梨衣</div>
          <div class="app-desc">蛇岐八家上杉家主，用黄色小本本与你对话</div>
        </div>
      ...
      <div class="app-card" @click="navigateTo('/super-agent')">
        ...
        <div class="app-info">
          <div class="app-title">YuManus 智能体</div>
          <div class="app-desc">ReAct自主规划，多工具协作完成任务</div>
        </div>
        <div class="app-button">
          <span class="btn-text">立即体验</span>
          <span class="btn-icon">→</span>
...
useHead({
  title: 'Sakura Agent应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: 'Sakura Agent应用平台提供上杉绘梨衣和YuManus 智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,上杉绘梨衣,AI助手,智能对话,Sakura,YuManus 智能体,首页'
    }
  ]
})
...
.auth-bar { text-align:center; margin-bottom:10px; }
.auth-bar, .auth-bar a { color:#e94560; font-size:14px; text-decoration:none; }
