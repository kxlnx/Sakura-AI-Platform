      ...
      <div v-for="(msg, index) in messages" :key="index" class="message-wrapper">
        ...
        <div v-if="!msg.isUser" 
          ...
          <div class="message-bubble">
            ...
            <!-- typing indicator 不合并在 v-html 里 -->
            <span v-if="connectionStatus === 'connecting' && index === messages.length - 1" class="typing-indicator" style="margin-left:12px">▋</span>
...
// 渲染 Markdown 为 HTML（marked v18 语法，选项直接传入 parse）
